...
public class GridShapeCopyToTests
{
    ...
    {
        using var source = new GridShape(5, 5, Allocator.Temp);
        using var target = new GridShape(5, 5, Allocator.Temp);
    ...
    {
        using var source = new GridShape(4, 4, Allocator.Temp);
        using var target = new GridShape(4, 4, Allocator.Temp);
    ...
    {
        using var source = new GridShape(3, 3, Allocator.Temp);
        using var target1 = new GridShape(4, 3, Allocator.Temp); // Different width
        using var target2 = new GridShape(3, 4, Allocator.Temp); // Different height
        using var target3 = new GridShape(2, 2, Allocator.Temp); // Both different
    ...
    {
        const int size = 100;
        using var source = new GridShape(size, size, Allocator.Temp);
        using var target = new GridShape(size, size, Allocator.Temp);
