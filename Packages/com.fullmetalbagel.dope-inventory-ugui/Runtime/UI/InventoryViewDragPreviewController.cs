...
//                 seen.Add(itemData.InstanceId);
//
//                 var sprite = _sharedInventoryData.TryGetSprite(itemData.DefinitionId);
//                 if (!sprite) continue;
//
...
//                 if (!_draggingViews.TryGetValue(itemData.InstanceId, out var preview) || preview == null)
//                 {
//                     preview = _sharedInventoryData.Pool.Get();
// #if UNITY_EDITOR
//                     preview.name = $"__preview__{itemData.InstanceId}";
// #endif
//                     preview.transform.SetParent(_view, false);
//                     var prt = (RectTransform)preview.transform;
//                     EnsureTopLeftAnchors(prt);
//                     _draggingViews[itemData.InstanceId] = preview;
//                 }
//
...
//                 }
//
//                 var canPlace = inventory.CanMoveItem(itemData.InstanceId, shape, gridPos);
